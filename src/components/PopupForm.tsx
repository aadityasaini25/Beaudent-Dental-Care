    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg p-6 w-full max-w-xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl md:text-2xl font-bold text-[#5d2350]">Book Your Appointment</h2>
          <button onClick={onClose} className="text-gray-500 hover:text-gray-700 text-2xl">&times;</button>
        </div>

        {/* Offer info */}
        <div className="bg-pink-50 p-3 md:p-4 rounded-lg mb-4 border-l-4 border-[#5d2350]">
          <p className="text-sm md:text-base text-gray-700 text-center">
            <span className="text-[#5d2350] font-bold"> with Our Expert Endodontist</span>
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-[#5d2350] text-white py-3 md:py-4 rounded-lg font-bold text-lg hover:opacity-90 transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
          >
