  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
        <div className="bg-[#964782] p-6 text-center">
        ...
        <div className="p-6 md:p-8">
          <div className="flex flex-col md:flex-row items-center gap-8 mb-8">
            <div className="w-48 h-48 relative rounded-full overflow-hidden border-4 border-gray-200">
              <Image
                src="/images/doctor/Dr. Ankita Nagrani.png"
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-[#964782] font-medium mb-4">
                Endodontist
              </p>
          ...
          <div className="border-t border-gray-200 pt-6">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-8">
              <div className="bg-gray-50 p-4 rounded-lg text-center">
                <div className="text-[#964782] text-xl font-bold mb-2">1</div>
                <p className="text-sm text-gray-600">
                  We&apos;ll review your appointment request within 2 hours
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg text-center">
                <div className="text-[#964782] text-xl font-bold mb-2">2</div>
                <p className="text-sm text-gray-600">
                  Our team will call you to confirm the appointment
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg text-center">
                <div className="text-[#964782] text-xl font-bold mb-2">3</div>
                <p className="text-sm text-gray-600">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex justify-center items-center px-6 py-3 bg-[#964782] text-white font-medium rounded-lg hover:bg-[#7a326a] transition-colors gap-2"
            >
